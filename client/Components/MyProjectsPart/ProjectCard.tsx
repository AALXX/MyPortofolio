            ...
            {projectSelected ? (
                <div>
                    <div className='flex 2xl:h-40  h-[5rem] sm:h-[8rem] '>
                        <img className='2xl:w-28 2xl:h-28 2xl:mt-5 2xl:ml-5 ' src={`${process.env.SERVER_BACKEND}/get-projects/logo/${props.projectLogo}`} />
                    ...
                    <hr className='w-full self-center 2xl:mt-8' />
                        ...
                        <button className='h-7 self-center mr-4 2xl:mt-14 mt-5' onClick={() => { setProjectSelected(!projectSelected) }}>
                ...
                <div
                    ...
                    <img className='2xl:w-80 2xl:h-80 w-44 h-44 sm:w-52 sm:h-52 self-center' src={`${process.env.SERVER_BACKEND}/get-projects/logo/${props.projectLogo}`} />
                </div>
            )}
